...
WINDOW_ICONS = {
    ...
    'code': fa.icons['code'],
    'notable': fa.icons['book'],
    'Org.gnome.Nautilus': fa.icons['folder'],
    'jetbrains-rider': fa.icons['windows'],
    'code-insiders': fa.icons['windows'],
    'code - insiders': fa.icons['windows'],
    'telegram-desktop': fa.icons['telegram'],
    'sharplab-nativefier-a4412f': fa.icons['magic'],
    'linear-nativefier-269fcf': fa.icons['book']
...
def rename_workspaces(i3, icon_list_format='default'):
    ...
    for ws_index, workspace in enumerate(i3.get_tree().workspaces()):
        ...
        logging.info(
        'Number after parsing: %s' % str(name_parts.num))
